...
{
 private:
    tensor_hao::TensorHao<std::complex<double>, 2> densityDensityMatrixNum;
 ...
 public:
    ...
    const TensorHao<complex<double>, 2> returnDensityDensityMatrix();
    void write() const;
    void mixedWrite() const;
 ...
 private:
    ...
    void addDensityDensityMatrix(BCSSDOperation &bcssdOperation, std::complex<double> denIncrement);
    void addDensityDensityMatrixBCSBP(BCSSDOperation &bcssdOperation, std::complex<double> denIncrement);
