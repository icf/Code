...
void AfqmcConstraintPathMethod::read(const string &filename)
{
    ...
    readBySearchString(rotation00, "rotation00", filename);
    readBySearchString(rotation01, "rotation01", filename);
    readBySearchString(rotation10, "rotation10", filename);
    readBySearchString(rotation11, "rotation11", filename);
...
void AfqmcConstraintPathMethod::write(const string &filename)
{
    ...
    file<<setw(36)<<"rotation00 "<<setw(26)<<rotation00<<endl;
    file<<setw(36)<<"rotation01 "<<setw(26)<<rotation01<<endl;
    file<<setw(36)<<"rotation10 "<<setw(26)<<rotation10<<endl;
    file<<setw(36)<<"rotation11 "<<setw(26)<<rotation11<<endl;
...
void AfqmcConstraintPathMethod::print()
{
    ...
    cout<<setw(36)<<"rotation00 "<<setw(26)<<rotation00<<endl;
    cout<<setw(36)<<"rotation01 "<<setw(26)<<rotation01<<endl;
    cout<<setw(36)<<"rotation10 "<<setw(26)<<rotation10<<endl;
    cout<<setw(36)<<"rotation11 "<<setw(26)<<rotation11<<endl;
...
void MPIBcast(AfqmcConstraintPathMethod &buffer, int root, MPI_Comm const &comm)
{
    ...
    MPIBcast(buffer.rotation00);
    MPIBcast(buffer.rotation01);
    MPIBcast(buffer.rotation10);
    MPIBcast(buffer.rotation11);
...
void AfqmcConstraintPathMethod::setDefault()
{
    ...
    rotation00 = complex <double> (1.0,0.0);
    rotation01 = complex <double> (0.0,0.0);
    rotation10 = complex <double> (0.0,0.0);
    rotation11 = complex <double> (1.0,0.0);
    scSteps = 5;
