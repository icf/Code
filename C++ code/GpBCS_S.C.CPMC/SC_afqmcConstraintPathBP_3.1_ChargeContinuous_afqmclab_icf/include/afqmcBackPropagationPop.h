...
class AfqmcBackPropagationPop
{
    ...
    std::vector<std::complex<double>> *reWeightBPMeasure;
    WalkerRight *walkerBPMeasure;

 public:
    AfqmcBackPropagationPop();
    AfqmcBackPropagationPop(size_t BPNumber_in,
                            std::vector<TwoBodyAux> &twoBodyAuxBPMeasure_in,
                            std::vector< std::complex<double> > &reWeightBPMeasure_in,
