...
class BCSSDOperation
{
    ...
    tensor_hao::TensorHao< std::complex<double>, 2 > densityDensityMatrix; bool densityDensityMatrixIsCalculated; bool densityDensityMatrixBCSBPIsCalculated;
 ...
 public:
    ...
    const tensor_hao::TensorHao< std::complex<double>, 2 > &returnDensityDensityMatrix();
    ...
    const tensor_hao::TensorHao< std::complex<double>, 2 > &returnDensityDensityMatrixBCSBP();
