...
thermalSize               = 80
writeNumber               = 20
measureNumberPerWrite     = 5
measureSkipStep           = 5
walkerSizePerThread       = 250
backPropagationStep       = 40
...
#S.C. params 
initialSCPhiTFlag         = "setFromDensity_Analytical"   #"setFromDensity_Analytical", "setFromDensity_VMGpBCS","setFromGHF" 
rotation00ABS             = 1.0
rotation00Phase           = 0.0
rotation01ABS             = 0.0
rotation01Phase           = 0.0
