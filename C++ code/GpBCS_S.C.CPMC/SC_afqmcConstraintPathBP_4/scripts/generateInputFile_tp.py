...
initialSCPhiTFlag         = "setFromDensity_VMGpBCS"   #"setFromDensity_Analytical", "setFromDensity_VMGpBCS","setFromDensity_VMGpBCS_withGHF_orbital","setFromGHF","setFromGHF_readOccupancy","setFromDensity_VMGpBCS_withInput_orbital": only work in pBCS->GpBCS form 
scSteps                   = 2  
