...
#up_i, up_j, up_K = HubbardNearestNeighborHoppingOpenOneDimension(latt, ktwist, t1, openD=1)
...
measureSkipStep           = 10
walkerSizePerThread       = 200
backPropagationStep       = 400
decompType                = "densitySpin"  # "densityCharge", "densitySpin", "hopCharge", "hopSpin", "chargeDec"
forceType                 = "dynamicForce"   # "dynamicForce", "constForce"
forceCap                  = 1.5
initialPhiTFlag           = "readFromFile"   #"setFromModel", "setRandomly", "readFromFile": phiT.dat
#S.C. params 
initialSCPhiTFlag         = "setFromDensity_GHF"   #"setFromDensity_Analytical", "setFromDensity_VMGpBCS","setFromGHF" 
rotation00ABS             = 1.0
rotation00Phase           = 0.0
rotation01ABS             = 0.0
rotation01Phase           = 0.0
