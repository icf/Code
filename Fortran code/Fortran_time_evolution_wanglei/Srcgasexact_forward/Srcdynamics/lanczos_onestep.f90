subroutine lanczos_onestep(step,direction,stepforcycle,matsize,dim,nup,ndo,dt,Hlanc,Eigenvalue, phi,phi_time)
use lanc_param
implicit none

real(kind=8):: dt
integer:: step, matsize, dim, nup,ndo, stepforcycle, direction
