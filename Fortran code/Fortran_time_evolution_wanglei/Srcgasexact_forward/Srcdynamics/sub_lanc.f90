...
!=============================================================================================
!===================================================================================================
subroutine sub_lanc_without_schmit(nup, ndo, sub_en)
use prec
use lanc_param
use hubbard_param
use flags_param
...
real (kind=RKind), allocatable:: Phi(:, :), Phitemp(:)    !Phi(# of bisis for LM, # of basis in Hilbert space)
real (kind=RKind):: Have(0: Lanc_size-1), Bb(0:Lanc_size-1) ! elements of the Lanczos Matrix
...
alloc_error=0
allocate(Phi(0:matsize-1 ,dim), stat=alloc_error)
if(alloc_error/=0) then
print *, 'wrong in allocate Phi', alloc_error
stop
endif

alloc_error=0
allocate(Phitemp(dim), stat=alloc_error)
if(alloc_error/=0) then
print *, 'wrong in allocate Phi', alloc_error
stop
endif
...
enddo
 ...
 ! call initialize_phi(nstate(nup, ndo), nup, ndo, Phi(0,:))
...
end subroutine sub_lanc_without_schmit
