...
!----------------------------------------
    !--------------------------------
 call openUnit('Hzero1',80,'R')
 call openUnit('Hzero2',81,'R')
 call openUnit('Hzero3',82,'R')
 call openUnit('Hzero4',83,'R')
do i=1,Nsite,1
write(80,'(10f15.8)')real(Nsite)
 write(80,'(10f15.8)')real(Hzero(i,1:Nsite)) 
 write(81,'(10f15.8)')Hzero(i+Nsite,1:Nsite)
 write(82,'(10f15.8)')Hzero(i,1+Nsite:Nsite+Nsite)
 write(83,'(10f15.8)')Hzero(i+Nsite,1+Nsite:Nsite+Nsite)
enddo
 close(80)
 close(81)
 close(82)
...
!--------------
cicj_sc_global1(1:2*Nsite,1:2*Nsite)=0
cicj_sc_global1(1:Nsite,1:Nsite)=ph(1:Nsite,1:Nspin(1))*conjg(transpose(ph(1:Nsite,1:Nspin(1))))
cicj_sc_global1(Nsite+1:2*Nsite,Nsite+1:2*Nsite)=cicj_sc_global1(1:Nsite,1:Nsite)
