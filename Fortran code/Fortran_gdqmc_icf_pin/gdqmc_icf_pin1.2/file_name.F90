...
call copyName(BaseName,ccName)
call appendBaseName(ccName,'_cc.dat') !cc is 1-c^+ici-c^+jcj in non-translational symmetry

call copyName(BaseName,SzName)
call appendBaseName(SzName,'_Sz.dat') !Sz is c^+ici-c^j+cj in non-translational symmetry
