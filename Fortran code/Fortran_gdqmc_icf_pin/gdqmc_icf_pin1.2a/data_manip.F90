...
do i=0,max_n,1
   ...
   do sitei=1,2*Nsite,1
      do sitej=1,2*Nsite,1
         call err_anal(real(cicj_l_global(1:Nsamples,sitei,sitej,i)),Nsamples,cicj_sc_global(sitei,sitej),err)
      enddo
   end do

   do sitei=1,Nsite,1
      write(60,'(I4,3f15.8)') sitei,pt,1-(cicj_sc_global(sitei,sitei))-(cicj_sc_global(sitei+Nsite,sitei+Nsite))
      write(70,'(I4,3f15.8)') sitei,pt,((cicj_sc_global(sitei,sitei))-(cicj_sc_global(sitei+Nsite,sitei+Nsite)))
   enddo
end do
close(10)
close(20)
