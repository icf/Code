...
!TEMP
complex(kind=8)::temp_m(Nsite,Nsite)
...
call zgemm('N','N',Nsite,   Nspin(2),Nsite,   one,Fpairing(:,:),Nsite      &
...
call zgemm('N','T',Nspin(1),Nsite,Nspin(1),one,AA,Nspin(1)                        &
     &      ,conjg(NewPhu),Nsite,zero,Am1Phut,Nspin(1))

call zgemm('N','N',Nsite   ,Nsite,   Nspin(1),one,NewFPhd,Nsite                   &
     &      ,Am1Phut,Nspin(1),zero,Green(1:Nsite,1:Nsite),Nsite)

temp_m(1:Nsite,1:Nsite)=Green(1:Nsite,1:Nsite)
Green(1:Nsite,1:Nsite)=transpose(temp_m(1:Nsite,1:Nsite))
...
call zgemm('T','T',Nspin(1),Nsite,Nspin(2),one,conjg(AAsmall),Nspin(2)                   &
     &      ,conjg(NewPhd),Nsite,zero,Am1tPhdt,Nspin(1))

call zgemm('N','N',Nsite   ,Nsite,   Nspin(1),one,NewFDPhu,Nsite                   &
     &      ,Am1tPhdt,Nspin(1),zero,Green(Nsite+1:2*Nsite,Nsite+1:2*Nsite),Nsite)

temp_m(1:Nsite,1:Nsite)=Green(Nsite+1:2*Nsite,Nsite+1:2*Nsite)
Green(Nsite+1:2*Nsite,Nsite+1:2*Nsite)=transpose(temp_m(1:Nsite,1:Nsite))
