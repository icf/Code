...
call zgemm('N','T',Nsite,Nsite,Nsite,one,temp_BCS_sc(1,1),Nsite,conjg(cicj_sc_global_dn),Nsite,zero,BCS_sc(1,1),Nsite)
...
!cicj_sc_global_up=0
!cicj_sc_global_dn=0
!cicj_sc_global_up(1:Nsite,Nsite-Nspin(1)+1:Nsite)=phi_sc(1:Nsite,1:Nspin(1),1)
!cicj_sc_global_dn(1:Nsite,Nsite-Nspin(2)+1:Nsite)=phi_sc(1:Nsite,Nspin(1)+1:Ntot,1)
