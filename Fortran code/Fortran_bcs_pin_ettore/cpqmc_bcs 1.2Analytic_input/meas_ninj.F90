...
do sitei=1,Nbravais,1
  do ib=1,Nbands
     ...
     &                                                  -Amat(i,j)*Amat(j,i)
         ...
         ninj(sitei,ib,sitej,jb)=ninj(sitei,ib,sitej,jb)+Amat(i,i)*Amat(jdn,jdn)-Amat(i,j+Nsite)*Amat(i+Nsite,j)

         !term 3 <c+r_dn cr_dn c+oup coup>
         ninj(sitei,ib,sitej,jb)=ninj(sitei,ib,sitej,jb)+Amat(idn,idn)*Amat(j,j)-Amat(j,i+Nsite)*Amat(j+Nsite,i)
...
!Anomalous terms
        ninj(sitei,ib,sitej,jb)=ninj(sitei,ib,sitej,jb)
        ninj(sitei,ib,sitej,jb)=ninj(sitei,ib,sitej,jb)
...
do sitei=1,Nbravais,1
  do ib=1,Nbands
     ...
     &                                                  -Amat(i,j)*Amat(j,i)
         ...
         !term 2 -<c+r_up cr_up c+odn codn>
         szsz(sitei,ib,sitej,jb)=szsz(sitei,ib,sitej,jb)-Amat(i,i)*Amat(jdn,jdn)+Amat(i,j+Nsite)*Amat(i+Nsite,j)

         !term 3 -<c+r_dn cr_dn c+oup coup>
         szsz(sitei,ib,sitej,jb)=szsz(sitei,ib,sitej,jb)-Amat(idn,idn)*Amat(j,j)+Amat(j,i+Nsite)*Amat(j+Nsite,i)
...
!Anomalous terms
        szsz(sitei,ib,sitej,jb)=szsz(sitei,ib,sitej,jb)
        szsz(sitei,ib,sitej,jb)=szsz(sitei,ib,sitej,jb)
