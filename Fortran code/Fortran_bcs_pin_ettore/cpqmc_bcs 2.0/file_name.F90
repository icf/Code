...
!-----------------------------------
call copyName(BaseName,cdensityName)
call appendBaseName(cdensityName,'_chargedensity')
call appendBaseName(cdensityName,'_.dat')


call copyName(BaseName,sdensityName)
call appendBaseName(sdensityName,'_spindensity')
call appendBaseName(sdensityName,'_.dat')

call copyName(BaseName,nupnuptName)
call appendBaseName(nupnuptName,'_upnupt')
call appendBaseName(nupnuptName,'_.dat')

call copyName(BaseName,ndnnuptName)
call appendBaseName(ndnnuptName,'_ndnnupt')
call appendBaseName(ndnnuptName,'_.dat')
