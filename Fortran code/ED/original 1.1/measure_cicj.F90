...
do i=1,2*Nlattice,1
   do j=1,2*Nlattice,1
      if(i.gt.Nlattice.and.j.le.Nlattice)write(99,*)(0.d0,0.d0);
      if(i.le.Nlattice.and.j.gt.Nlattice)write(99,*)(0.d0,0.d0);
      if(i.le.Nlattice.and.j.le.Nlattice)write(99,*)cijup(i,j);
      if(i.gt.Nlattice.and.j.gt.Nlattice)write(99,*)cijdn(i-Nlattice,j-Nlattice);
   end do
enddo
close(99)
