function [phi, w, O, invO_matrix_up, invO_matrix_dn] = halfK_pin(phi, w, O, Proj_k_half, Proj_pin_up_half, Proj_pin_dn_half, Phi_T, N_up, N_par)
...
% "CPMC-Lab: A Matlab Package for Constrained Path Monte Carlo Calculations" Comput. Phys. Commun. (2014)
    ...
    phi=Proj_k_half*phi;
    phi(:,1:N_up)=Proj_pin_up_half*phi(:,1:N_up);
    phi(:,N_up+1:N_par)=Proj_pin_dn_half*phi(:,N_up+1:N_par);
