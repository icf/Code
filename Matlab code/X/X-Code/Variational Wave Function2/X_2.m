...
for i=1:N_run
    ...
    N_trace=[];
    for j=1:N_iteration
        [E_trace,N_trace,a,w,a_step_length,w_step_length]=X_RBM_update3_2(a,w,Phi_T,N_sites,N_y,a_step_length,w_step_length,E_step_length,N_up(i),N_dn(i),U,H_k,E_trace,N_trace);
