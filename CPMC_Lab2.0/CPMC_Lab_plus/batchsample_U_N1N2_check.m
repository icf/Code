...
for i=1:N_run
    ...
    [E_ave(i),E_err(i),savedFile]=CPMC_Lab_N1N2(Lx,Ly,Lz,N_up,N_dn,kx,ky,kz,U(i),U12,tx,ty,tz,deltau,N_wlk,N_blksteps,N_eqblk,N_blk,itv_modsvd,itv_pc,itv_Em,suffix);    
end
%% post-run:
