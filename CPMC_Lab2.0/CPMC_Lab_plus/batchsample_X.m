...
N_blksteps=[100:20:100]; % The number of random walk steps in each block
...
for i=1:N_run
    ...
    [E_ave(i),E_err(i),savedFile]=CPMC_Lab_X(Lx,Ly,Lz,N_up,N_dn,kx,ky,kz,U,tx,ty,tz,deltau,N_wlk,N_blksteps(i),N_eqblk,N_blk,itv_modsvd,itv_pc,itv_Em,suffix);    
end
%% post-run:
