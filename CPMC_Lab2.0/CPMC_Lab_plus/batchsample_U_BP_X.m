...
U=[8:0.1:8]; % The on-site repulsion strength in the Hubbard Hamiltonian
...
for i=1:N_run
    ...
    [E_ave(i),E_err(i),E_BP_ave(i),E_BP_err(i),E_V_BP_ave(i),E_V_BP_err(i),E_K_BP_ave(i),E_K_BP_err(i),savedFile]=CPMC_Lab_BP_X(Lx,Ly,Lz,N_up,N_dn,kx,ky,kz,U(i),tx,ty,tz,deltau,N_wlk,N_blksteps,N_eqblk,N_blk,itv_modsvd,itv_pc,itv_Em,suffix);    
end
%% post-run:
