function e = measure_NiNi(H_k, phi, Phi_T, invO_matrix_up, invO_matrix_dn, N_up, N_par, U, U1)
...
% "CPMC-Lab: A Matlab Package for Constrained Path Monte Carlo Calculations" Comput. Phys. Commun. (2014)
    ...
    %U1 added, icf 2017/9/20
    n_int=(diag(G_up)).'*diag(G_dn)-G_up(1,1)'*G_dn(1,1);
    potentialEnergy=n_int*U+U1*G_up(1,1)'*G_dn(1,1);
