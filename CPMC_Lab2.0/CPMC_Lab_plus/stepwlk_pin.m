function [phi, w, O, E, W] = stepwlk_pin(phi, N_wlk, N_sites, w, O, E, W, H_k, Proj_k_half, Proj_pin_up_half, Proj_pin_dn_half, flag_mea, Phi_T, N_up, N_par, U, fac_norm, aux_fld)
