...
H_pin_dn=H_PIN_dn(Lx, Ly,Lz, kx, ky,kz, tx, ty,tz);
% the matrix of the operator exp(-deltau*H_pin/2)
Proj_pin_up_half = expm(-0.5*deltau*H_pin_up); 
Proj_pin_dn_half = expm(-0.5*deltau*H_pin_dn); 
...
%HF, icf 2017/10/20
[Phi_T(:,:),~]=HF(Lx,Ly,Lz,N_up,N_dn,N_par,N_sites,N_it,kx,ky,kz,U,tx,ty,tz,a);  
