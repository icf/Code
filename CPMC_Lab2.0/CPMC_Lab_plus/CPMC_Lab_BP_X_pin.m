function [E_ave,E_err,E_BP_ave,E_BP_err,E_V_BP_ave,E_V_BP_err,E_K_BP_ave,E_K_BP_err,savedFileName]=CPMC_Lab_BP_X_pin(Lx,Ly,Lz,N_up,N_dn,kx,ky,kz,U,tx,ty,tz,deltau,N_wlk,N_blksteps,N_eqblk,N_blk,itv_modsvd,itv_pc,itv_Em,suffix,phi_2)
...
%% Initialization
tic; % start the  timer
initialization_BP_X_pin; % initialize internal constants, form the trial wave function and assemble the initial population of walkers
format long;
