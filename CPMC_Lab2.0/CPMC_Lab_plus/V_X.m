function [phi, O, w, invO_matrix_up, invO_matrix_dn, invO_matrix_up2, invO_matrix_dn2] = V_X(phi, phi_T, phi_T2, N_up, N_par, O, w, invO_matrix_up, invO_matrix_dn, invO_matrix_up2, invO_matrix_dn2, aux_fld)
...
Gii(1,1)=temp1_up*phi_T(1:N_up)';
Gii(2,1)=temp1_dn*phi_T(N_up+1:N_par)';
RR=(aux_fld-matone).*horzcat(Gii,Gii)+matone;
%
temp1_up2=phi(1:N_up)*invO_matrix_up2;
temp1_dn2=phi(N_up+1:N_par)*invO_matrix_dn2;
temp2_up2=invO_matrix_up2*phi_T2(1:N_up)';
temp2_dn2=invO_matrix_dn2*phi_T2(N_up+1:N_par)';
Gii2(1,1)=temp1_up2*phi_T2(1:N_up)';
Gii2(2,1)=temp1_dn2*phi_T2(N_up+1:N_par)';
RR2=(aux_fld-matone).*horzcat(Gii2,Gii2)+matone;
%
...
if w>0
    ...
    %
    invO_matrix_up2=invO_matrix_up2+(1-aux_fld(1,x_spin))/RR2(1,x_spin)*temp2_up2*temp1_up2;
    invO_matrix_dn2=invO_matrix_dn2+(1-aux_fld(2,x_spin))/RR2(2,x_spin)*temp2_dn2*temp1_dn2;
else
    jjj=0
end
