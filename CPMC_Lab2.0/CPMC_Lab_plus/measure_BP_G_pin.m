function [e, e_V, e_K, g] = measure_BP_G_pin(H_k, phi, Phi_T, N_sites, N_up, N_par, U, x, Proj_k_half, Proj_pin_up_half, Proj_pin_dn_half, itv_Em, aux_fld, itv_modsvd)
...
% "CPMC-Lab: A Matlab Package for Constrained Path Monte Carlo Calculations" Comput. Phys. Commun. (2014)
    ...
    for i_step=1:itv_Em
        ...
        Phi = stepwlk_BP_pin(Phi, x(:,mod(itv_Em-i_step, itv_Em)+1), N_sites, Proj_k_half, Proj_pin_up_half, Proj_pin_dn_half, N_up, N_par, aux_fld);
        %
