...
U=[0.1:0.8:8.1]; % The on-site repulsion strength in the Hubbard Hamiltonian
U1=U;
...
for i=1:N_run
    ...
    [E_ave(i),E_err(i),savedFile]=CPMC_Lab_NiNi(Lx,Ly,Lz,N_up,N_dn,kx,ky,kz,U(i),U1(i),tx,ty,tz,deltau,N_wlk,N_blksteps,N_eqblk,N_blk,itv_modsvd,itv_pc,itv_Em,suffix);    
end
%% post-run:
