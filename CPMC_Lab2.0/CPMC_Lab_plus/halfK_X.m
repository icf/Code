function [phi, w, O, invO_matrix_up, invO_matrix_dn, invO_matrix_up2, invO_matrix_dn2] = halfK_X(phi, w, O, Proj_k_half, Phi_T, Phi_T2, N_up, N_par)
...
% "CPMC-Lab: A Matlab Package for Constrained Path Monte Carlo Calculations" Comput. Phys. Commun. (2014)
    ...
    %
    invO_matrix_up2=inv(Phi_T2(:,1:N_up)'*phi(:,1:N_up));
    invO_matrix_dn2=inv(Phi_T2(:,N_up+1:N_par)'*phi(:,N_up+1:N_par));
