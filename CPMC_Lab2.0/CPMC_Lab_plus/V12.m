function [phi1, phi2, O, w, invO_matrix_up, invO_matrix_dn] = V12(phi1, phi2, phi_T1, phi_T2, N_up, N_par, O, w, invO_matrix_up, invO_matrix_dn, aux_fld)
...
temp1_up=phi1(1:N_up)*invO_matrix_up;
temp1_dn=phi2(N_up+1:N_par)*invO_matrix_dn;
temp2_up=invO_matrix_up*phi_T1(1:N_up)';
temp2_dn=invO_matrix_dn*phi_T2(N_up+1:N_par)';
Gii(1)=temp1_up*phi_T1(1:N_up)';
Gii(2)=temp1_dn*phi_T2(N_up+1:N_par)';
...
if w>0
    ...
    phi1(1:N_up)=phi1(1:N_up)*aux_fld(1,x_spin);
    phi2(N_up+1:N_par)=phi2(N_up+1:N_par)*aux_fld(2,x_spin);    
