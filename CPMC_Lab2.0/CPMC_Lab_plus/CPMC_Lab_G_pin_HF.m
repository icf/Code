function [E_ave,E_err,E_BP_ave,E_BP_err,E_V_BP_ave,E_V_BP_err,E_K_BP_ave,E_K_BP_err,G_BP_ave_T,G_BP_err_T,savedFileName]=CPMC_Lab_G_pin_HF(Lx,Ly,Lz,N_up,N_dn,kx,ky,kz,U,tx,ty,tz,deltau,N_wlk,N_blksteps,N_eqblk,N_blk,itv_modsvd,itv_pc,itv_Em,suffix)
...
%% Initialization
tic; % start the  timer
initialization_pin_HF; % initialize internal constants, form the trial wave function and assemble the initial population of walkers
format long;
