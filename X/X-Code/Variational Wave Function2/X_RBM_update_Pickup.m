...
[E,~,~,N]=Energy_X_RBM3_2(a,w,Phi_T,N_sites,N_y,N_up,N_dn,U,H_k);
if length(E_trace)==0
    E_trace(end+1) = E;
    N_trace=N;
else
...
for i2=1:N_sites+1    
    ...
    for j2=1:1
        ...
        a0=a;
        w0=w;
        [E21,~,~,N21]=Energy_X_RBM3_2(a+delta_a,w+delta_w,Phi_T,N_sites,N_y,N_up,N_dn,U,H_k);
        [E22,~,~,N22]=Energy_X_RBM3_2(a-delta_a,w+delta_w,Phi_T,N_sites,N_y,N_up,N_dn,U,H_k);
        [E23,~,~,N23]=Energy_X_RBM3_2(a+delta_a,w-delta_w,Phi_T,N_sites,N_y,N_up,N_dn,U,H_k);
        [E24,~,~,N24]=Energy_X_RBM3_2(a-delta_a,w-delta_w,Phi_T,N_sites,N_y,N_up,N_dn,U,H_k);
        %
