...
if(rank.eq.0) WRITE(fileID,*) '   *Readable Time:  ', days , ' Days, ', hours, ' Hours, ', minutes, ' Minutes, ', seconds, ' seconds'
...
if(rank.eq.0) PRINT *, '   *Readable Time:  ', days , ' Days, ', hours, ' Hours, ', minutes, ' Minutes, ', seconds, ' seconds'
